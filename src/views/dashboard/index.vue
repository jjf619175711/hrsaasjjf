<template>
  <div class="dashboard-container">
    ...
    <!-- 离职弹层 -->
    <el-dialog :visible="showDialog" title="离职申请" @close="btnCancle">
      <!-- 表单 -->
      <el-form
        ref="ruleForm"
        :model="ruleForm"
...
<script>
import WorkCalendar from './componets/work-calendar.vue'
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        exceptTime: [
          { required: true, message: '离职时间时间不能为空', trigger: 'blur' }
        ],
        reason: [
