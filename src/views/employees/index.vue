  ...
  <div class="dashboard-container">
    <div class="app-container">
      <page-tools :show-before="true">
        ...
        <!-- 右侧显示按钮 excel导入 新增员工 -->
        <template #after>
          <el-button size="small" type="success" @click="importExcel">excel导入</el-button>
          <el-button size="small" type="danger" @click="exportData">excel导出</el-button>
          <el-button size="small" type="primary" @click="showD">新增员工</el-button>
        </template>
      </page-tools>
      ...
      <!-- 放置组件弹出层 -->
      <AddEmployee :show-dialog.sync="showDialog" @getEmployees="getEmployees" />
    </div>
  </div>
</template>
